...
public class plataforma {
    ...
    public void salvarUsuarios() throws Exception{
        ...
        Path arquivo = Paths.get("arquivos/Usuarios.csv");
    ...
    public void carregarCatalogo()throws Exception{
        ...
        Path p = Paths.get("arquivos/Catalogo.csv");
        ...
        for(String linha : linhas){
            ...
            {
                Conteudo c = new Serie(partes[1], partes[2], partes[3], partes[4], ano, nota);
                catalogo.add(c);
            }
        }
    }
    ...
    public void carregarUsuarios() throws Exception{
        ...
        Path p = Paths.get("arquivos/Usuarios.csv");
        List<String> linhas = Files.readAllLines(p);
