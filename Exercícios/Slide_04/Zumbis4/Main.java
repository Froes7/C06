        ...
        while(n!=3){
            ...
            switch(n){
                ...
                case 2:
                    ...
                    q = entrada.nextInt();
                    if(x==1){
                        if(zumbi1.transfereVida(zumbi2, q) == true){
                            System.out.println("Vida transferida!");
                        }
                        else{
                            System.out.println("Não foi possível transferir, verifique a vida de seu zumbi!");
                        }
                    }
                    else if(x==2){
                        if(zumbi2.transfereVida(zumbi1, q) == true){
                            System.out.println("Vida transferida!");
                        }
                        else{
                            System.out.println("Não foi possível transferir, verifique a vida de seu zumbi!");
